/*
	Figure 3-6 An assignment statement error message

	The assignment statement for lv_days_num has been 
	modified to contian an error.  The colon is missing
	in the assignment statement operator.
*/
