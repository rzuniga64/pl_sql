/* 
	Figure 3-9 A "no data found" error from a SELECT statement

	Notice the reference to "no data found".  A SELECT statement
	embedded in a PL/SQL block must return a row, or it generates
	this error.
*/
DECLARE 
